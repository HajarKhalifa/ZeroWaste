...
import 'package:zeros/house/components/card.dart';
...
class _HouseScreenState extends State<HouseScreen>
  ...
  checkingInfo() {
    if (widget.pageInfo == "Door To Door") {
      setState(() {
        orderBy = "Door To Door";
      });
    } else if (widget.pageInfo == "Branch") {
      setState(() {
        orderBy = "Branch";
      });
    }
        ...
        child: Scaffold(
          ...
          body: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                //   descending: true,
                // )
                .where('ServeceStatus', isEqualTo: orderBy)
                .snapshots(),
            builder: (context,
