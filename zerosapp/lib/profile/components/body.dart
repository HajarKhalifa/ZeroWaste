...
import 'package:zeros/edit/editProfile.dart';
...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    UserCreaditials? userCreaditials = userProvider.getUser;
    if (userCreaditials == null) {
      // Return a loading indicator or an appropriate widget while the user details are being fetched
